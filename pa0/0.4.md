...
again and you will find that the interface `enp0s3` is allocated with an IP address which usually looks like `192.168.x.x`.
...
What you should do is 1. comment the line starts with `deb cdrom` with a `#` symbol at the start of this line:
