...
*Text below is exacted from original text with some modification:*
...
Online documentation for GNU debugger GDB: https://gcc.gnu.org/onlinedocs/
...
The `Makefile` you wrote should consist of functions below:
...
2. Able to clean the project directory by
...
The most important command in GNU/Linux is `man` - the on-line manual pager. This is because `man`can tell you how to use other commands. [Here](https://nju-ics.gitbooks.io/ics2017-programming-assignment/content/man.html) is a small tutorial for `man`. Remember, learn to use `man`, learn to use everything. Therefore, if you want to know something about GNU/Linux (such as shell commands, system calls, library functions, device files, configuration files...), [RTFM](http://en.wikipedia.org/wiki/RTFM).
